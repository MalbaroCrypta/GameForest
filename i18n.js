...
(function(){
  ...
  const dict = {
    uk: {
      ...
      aboutRoadmapQ1: "Q1 — публічний прев'ю з мультиплатформним каталогом, згенерованою історією цін, сторінками ігор.",
      ...
      aboutCtaCopy: "Потрібен партнер, інвестиція чи API-інтеграція? Напишіть — проведемо по продукту та цифрах.",
      aboutFaqTitle: "FAQ",
      ...
      footerDisclaimer: "Стабільні обкладинки SteamStatic. Дані кешуються, продакшен-розгортання не потребує сторонніх залежностей.",
    ...
    en: {
      ...
      aboutRoadmapBadge: "Delivery",
      aboutRoadmapQ1: "Q1 — Public preview with multi-platform catalog, generated price history, shareable game pages.",
      ...
      aboutOwnerCopy: "Malbaro owns product direction, investor relations, and partner onboarding. Ready to present metrics, monetization, and release plans.",
      aboutCta: "Contact / Partner / Investor",
      aboutCtaPitch: "Open Investor deck",
      aboutCtaTitle: "Call to action",
      aboutCtaCopy: "Looking to partner, invest, or embed the API? Reach out — we’ll walk through the product and numbers.",
      aboutFaqTitle: "FAQ",
      ...
      footerDisclaimer: "Stable SteamStatic covers. Cached data, no fragile external dependencies in production releases.",
