...
(function(){
  ...
  const dict = {
    uk: {
      ...
      heroCatalogSub: "Стисла таблиця у стилі SteamDB: фільтри, сортування, compare, локальні сесії.",
      ...
      heroMarketSub: "Поповнення балансів і цифрові предмети. Готово для продакшн-потоків.",
      ...
      tableTitle: "Таблиця",
      tableHint: "Стисла сітка у стилі SteamDB: клік по назві відкриває деталі, кнопки — wishlist та Compare (до 4).",
      actions: "Дії",
      thName: "Назва",
      thOff: "% Знижка",
      thPrice: "Ціна",
      ...
      marketDisclaimer: "Лоти для прев'ю. Для продажів потрібні KYC/KYB та дозволені механіки.",
      marketAction: "Відкрити ордер",
      ...
      faqQ2: "Це легально?",
      faqA2: "Прев'ю не продає товари. Для продакшену — тільки офіційні інтеграції та партнерські угоди.",
      faqQ3: "Точність 100%?",
      faqA3: "Цілі — свіжі ціни та алерти. Дані кешуються, валідуються, є стор-відхилення.",
      faqQ4: "Як часто оновлюємо?",
      faqA4: "У прев'ю — статично. У продакшену — щогодини для цін, миттєво для алертів.",
      faqQ5: "Звідки ціни?",
      ...
      footerDisclaimer: "Стабільні обкладинки SteamStatic. Спокійна збірка без сторонніх залежностей.",
    ...
    en: {
      ...
      heroCatalogSub: "SteamDB-style grid: filters, sorting, compare, local sessions.",
      ...
      heroMarketSub: "Balance top-ups and digital items. Ready for production handoff.",
      ...
      sortBadge: "Sort",
      tableTitle: "Table",
      tableHint: "Compact SteamDB-like grid: click a name to open details, buttons for wishlist and Compare (up to 4).",
      actions: "Actions",
      thName: "Name",
      thOff: "% Off",
      thPrice: "Price",
      ...
      marketDisclaimer: "Listings preview. Real trades require KYC/KYB and approved mechanics.",
      marketAction: "Start order",
      ...
      faqQ2: "Is this legal?",
      faqA2: "Preview doesn’t sell goods. Production uses only official integrations and partner agreements.",
      faqQ3: "Accuracy 100%?",
      ...
      footerDisclaimer: "Stable SteamStatic covers. Calm build without fragile dependencies.",
